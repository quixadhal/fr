    ...
    while (num_bytes > sizeof(int) && buf_index < (IN_BUF_SIZE - 1)) {
	  ...
	  continue;
        ...
        if (expecting && num_bytes < expecting) {
          /*
           * message truncated...back up to DATALEN message;
           * exit loop...and try again later
           */
	  ...
	  continue;
        ...
        if (num_bytes > (sizeof(int) + sizeof(int))) {
          ...
          /*
           * not enough bytes...assume truncated;
           * exit loop...we'll handle this message later
           */
          break;
        }
      } else {
	...
	continue;
      ...
      if (res) {
        ...
        expecting = 0;
            ...
            unread_bytes > 0) {
        /*
         * msglen == num_bytes could be a complete message...
         *   if there's unread data we'll assume it was truncated
         */
        break;
      } else {
        /*
