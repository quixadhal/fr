...
void print_prompt()
{
  ...
  /*
   * Put the IAC GA thing in here...
   * Moved from before writing the prompt; vt src says it's a terminator.
   * Should it be inside the no-input_to case? We'll see, I guess.
   */
