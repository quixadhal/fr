...
void
c_socket_create(svalue *ret, svalue *s0, svalue *s1, svalue *s2)
{
    int fd;
    struct svalue *mret;
    struct vector *info;
...
#ifdef F_SOCKET_BIND
void
c_socket_bind(svalue *ret, svalue *s0, svalue *s1)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_listen(svalue *ret, svalue *s0, svalue *s1)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_accept(svalue *ret, svalue *s0, svalue *s1, svalue *s2)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_connect(svalue *ret, svalue *s0, svalue *s1, svalue *s2, svalue *s3)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_write(svalue *ret, svalue *s0, svalue *s1, svalue *s2)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_close(svalue *ret, svalue *s0)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_release(svalue *ret, svalue *s0, svalue *s1, svalue *s2)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_acquire(svalue *ret, svalue *s0, svalue *s1, svalue *s2, svalue *s3)
{
    int i, fd, port;
    struct svalue *mret;
    struct vector *info;
...
void
c_socket_error(svalue *ret, svalue *s0)
{
    char *error;
...
void
c_socket_address(svalue *ret, svalue *s0)
{
    char *str;
    int port;
    char addr[ADDR_BUF_SIZE];
...
/* This is so we can get the address of interactives as well. */
	...
	C_NUMBER(ret, 0);
      ...
      sprintf(str, "%s %d", tmp, s0->u.ob->interactive->addr.sin_port);
...
void
c_dump_socket_status(svalue *ret)
{
  dump_socket_status();
  C_NUMBER(ret,0);
}
