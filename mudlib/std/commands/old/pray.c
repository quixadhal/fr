...
if(str=="healing"||str=="Healing")
   ...
   else if(str=="wisdom"||str=="Wisdom")
  {
   ...
   {
    tell_object(me,capitalize(god)+" tells you: Desist in annoying me or face my wrath!\n");
   ...
   if (num>=8001)
     {
    tell_object(me,capitalize(god)+" tells you: I have had it with your incessant "
