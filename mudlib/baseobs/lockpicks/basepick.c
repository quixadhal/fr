  /* Inherit "/std/pick_lock.c" to achieve desired results =) */
...
void setup(){
   ...
   /* Next line defines what TYPE of lock can be picked with this tool */
     /* Where "bolt" is one of the many types */
   add_property("tool_type","bolt");
}
