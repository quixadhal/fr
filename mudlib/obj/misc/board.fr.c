...
void set_board_name(string str) { 
	board_name = str; 
	if(!member_array(str,(string *)BOARD_HAND->list_of_boards()));
	    BOARD_HAND->create_board(str);}
void set_datafile(string str) { set_board_name(str); }
