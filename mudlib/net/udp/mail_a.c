...
// 
//  Revision:  
//   - Modified by Turrican to be used with DW mudlib.
//     Date    :  17th of Januari, 1995
//   - Cleaned up a bit by Turrican, 14-6-95
//
*/
...
void incoming_request(mapping info) {
  ...
  */
  (UDP_PATH+UDP_MAIL_Q)->check_for_mail(info["NAME"], flag);
}
