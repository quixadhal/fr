...
"     This is the Northern most point of the volcanic island you "
" have swum to.  A sharp cliff drops in every direction except to "
"the SouthEast and SouthWest.  To the South the massive jungle "
"to a point.  In every other direction, massive cliffs drop "
...
add_item("cliffs","The cliffs drop hundreds of feet straight down "
"to the churning ocean, below.\n");
add_item("ocean","The ocean is churning and swarming at the feet "
"of the cliffs below.\n");

add_exit("southeast",VOLCANO+"island10.c","path");
add_exit("southwest",VOLCANO+"island9.c","path");
}
