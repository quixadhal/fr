...
"     With the steep, sloping...  well, slope, of the volcano, and the rocky shoreline "
"the only options open to you in this sparse section of the jungle are to the North and "
"the SouthWest.  "
    "\n\n");
...
add_item("shoreline","The shoreline is rocky and totally unfit for swiming.\n");
