...
"     This section of the island is the NorthWesterly most part of the volcanic "
"island, and still shows no way of movement, other than the path you are on.  "
"The only available paths are mostly cut off by the dense forest and the sharp "
"cliffs of the island leaving only the South and the NorthEast open.  "
    "\n\n");
