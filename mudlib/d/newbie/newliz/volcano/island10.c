...
"     The island is coming to a head to the North of you.  The "
"massive jungle which surrounds you has no paths open, other than "
"to the SouthEast and the NorthWest.  Wonderful aromas from "
"jungle flowers surround you as you walk through this thick foilage.  "
    "\n\n");
...
add_exit("southeast",VOLCANO+"island8.c","path");
add_exit("northwest",VOLCANO+"island11.c","path");
}
