...
"     This is along the SouthEastern side of the island, simply circling the small "
"volcano.  The path is a little overgrown, but there is a newly cleared passage to "
"the NorthWest.  "
    "\n\n");
...
add_exit("northeast",VOLCANO+"island6.c","path");
add_exit("northwest",VOLCANO+"island5.c","path");
add_exit("southwest",VOLCANO+"island1.c","path");
}
