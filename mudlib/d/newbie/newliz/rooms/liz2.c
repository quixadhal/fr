...
"This section curves in the crescent moon shape of the island.  Only the "
"beach here is suitable for living.  The beach continues to the south and the "
"northeast.  "
    "\n\n");
...
add_exit("south",ROOMS+"liz1.c","path");
add_exit("west",ROOMS+"tavern.c","door");
