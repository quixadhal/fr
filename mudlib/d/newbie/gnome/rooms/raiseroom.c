...
set_long("Macedonia:  Temple of Reorx\n\n"
  ...
  add_sign(" Gnome Raiseroom.\n"
   ...
   //added by Christian oct 28  (items)//
  add_item(({"pews","seats","chairs","benches"}),"The pews are made of fine wood, and are "
"well taken care of by the priests of this chapel.\n");
add_item("altar","The altar is a massive carving of marble that dominates the front of the chapel.\n");
add_item(({"floor","ground"}),"The ground is made of fine, smooth marble.  It is a pale gray.\n");
