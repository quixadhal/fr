...
void setup() {
  set_short("Captive's Exchange");
  set_long("Captive's Exchange\n"
  ...
  set_light(30);
add_exit("west",MAZE+"guild.c","door");
  set_store_room(MAZE+"store");
...
//      clone_object(ARMOUR+"chainmail")->move(our_storeroom);
//      clone_object(ARMOUR+"helmet")->move(our_storeroom);
     clone_object("/baseobs/armours/cloak")->move(our_storeroom);
     clone_object("/baseobs/armours/leather")->move(our_storeroom);
}
