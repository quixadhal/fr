...
void setup() {
   ...
   add_exit("east",MAZE+"maze38","corridor");
   add_exit("west",MAZE+"maze36","corridor");
   add_exit("northeast",MAZE+"maze24","corridor");
   add_exit("southeast", MAZE+"maze52", "corridor");
   add_exit("southwest", MAZE+"maze50", "corridor");
