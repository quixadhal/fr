...
void setup() {
   ...
   add_exit("south",MAZE+"maze48","corridor");
   add_exit("east",MAZE+"maze35","corridor");
   add_exit("west",MAZE+"maze33","corridor");
   add_exit("northeast",MAZE+"maze21","corridor");
   add_exit("northwest", MAZE+"maze19", "corridor");
