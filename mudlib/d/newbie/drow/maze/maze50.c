...
void setup() {
   ...
   add_exit("south",MAZE+"maze64","corridor");
   add_exit("east",MAZE+"maze51","corridor");
   add_exit("west",MAZE+"maze49","corridor");
   add_exit("northeast",MAZE+"maze37","corridor");
   add_exit("southwest", MAZE+"maze63", "corridor");
