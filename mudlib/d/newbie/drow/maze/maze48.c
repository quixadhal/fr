...
void setup() {
   ...
   add_exit("north",MAZE+"maze34","corridor");
   add_exit("south",MAZE+"maze62","corridor");
   add_exit("east",MAZE+"maze49","corridor");
   add_exit("west",MAZE+"maze47","corridor");
   add_exit("northeast",MAZE+"maze35","corridor");
