...
void setup() {
   ...
   add_exit("north",MAZE+"maze46","corridor");
   add_exit("south",MAZE+"maze71","corridor");
   add_exit("east",MAZE+"maze61","corridor");
   add_exit("west",MAZE+"maze59","corridor");
   add_exit("northeast",MAZE+"maze47","corridor");
   add_exit("northwest", MAZE+"maze45", "corridor");
   add_exit("southwest", MAZE+"maze70", "corridor");
