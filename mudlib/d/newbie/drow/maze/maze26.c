...
void setup() {
   ...
   add_exit("north",MAZE+"maze12","corridor");
   add_exit("south",MAZE+"maze40","corridor");
   add_exit("east",MAZE+"maze27","corridor");
   add_exit("west",MAZE+"maze25","corridor");
   add_exit("northeast",MAZE+"maze13","corridor");
   add_exit("northwest", MAZE+"maze11", "corridor");
