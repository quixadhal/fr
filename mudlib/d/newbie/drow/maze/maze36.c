...
void setup() {
   ...
   add_exit("north",MAZE+"maze22","corridor");
   add_exit("east",MAZE+"maze37","corridor");
   add_exit("west",MAZE+"maze35","corridor");
   add_exit("northwest", MAZE+"maze21", "corridor");
   add_exit("southwest", MAZE+"maze49", "corridor");
