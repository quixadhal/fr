...
void setup() {
   ...
   add_clone(CHAR+"captives", random(2));
   add_clone(CHAR+"drole",random(4));
   add_smell("room", "It smells old.\n");
   add_taste("air", "The air tastes Musty and old.\n");

   add_exit("northeast",MAZE+"maze70","corridor");
   add_exit("northwest", MAZE+"maze68", "corridor");
   add_exit("southeast", MAZE+"maze92", "corridor");
   add_exit("southwest", MAZE+"maze90", "corridor");
