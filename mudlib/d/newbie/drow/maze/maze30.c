...
void setup() {
   ...
   add_exit("south",MAZE+"maze44","corridor");
   add_exit("east",MAZE+"maze31","corridor");
   add_exit("northeast",MAZE+"maze17","corridor");
   add_exit("northwest", MAZE+"maze15", "corridor");
   add_exit("southeast", MAZE+"maze45", "corridor");
