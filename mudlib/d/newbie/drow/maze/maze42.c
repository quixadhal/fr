...
void setup() {
   ...
   add_exit("north",MAZE+"maze28","corridor");
   add_exit("east",MAZE+"maze43","corridor");
   add_exit("west",MAZE+"maze41","corridor");
   add_exit("northwest", MAZE+"maze27", "corridor");
   add_exit("southeast", MAZE+"maze57", "corridor");
