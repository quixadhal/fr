...
void setup() {
   ...
   add_exit("north",MAZE+"maze40","corridor");
   add_exit("south",MAZE+"maze02","corridor");
   add_exit("east",MAZE+"maze55","corridor");
   add_exit("northwest", MAZE+"maze39", "corridor");
   add_exit("southwest", MAZE+"maze01", "corridor");
