...
void setup() {
   ...
   add_exit("north",MAZE+"maze35","corridor");
   add_exit("east",MAZE+"maze50","corridor");
   add_exit("west",MAZE+"maze48","corridor");
   add_exit("northeast",MAZE+"maze36","corridor");
   add_exit("southeast", MAZE+"maze64", "corridor");
