...
void setup() {
   ...
   add_exit("north",MAZE+"mazexx","corridor");
   add_exit("south",MAZE+"mazexx","corridor");
   add_exit("east",MAZE+"mazexx","corridor");
   add_exit("west",MAZE+"mazexx","corridor");
   add_exit("northeast",MAZE+"mazexx","corridor");
   add_exit("northwest", MAZE+"mazexx", "corridor");
   add_exit("southeast", MAZE+"mazexx", "corridor");
   add_exit("southwest", MAZE+"mazexx", "corridor");
