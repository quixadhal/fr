...
void setup() {
   ...
   add_exit("south",MAZE+"maze46","corridor");
   add_exit("east",MAZE+"maze33","corridor");
   add_exit("northeast",MAZE+"maze19","corridor");
   add_exit("northwest", MAZE+"maze17", "corridor");
   add_exit("southeast", MAZE+"maze47", "corridor");
   add_exit("southwest", MAZE+"maze45", "corridor");
