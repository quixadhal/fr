...
void reset() 
{
   ...
   if(!dispenser) 
     {
     dispenser = clone_object("/w/hokemj/machine");
     dispenser->move(this_object());
  }
}
...
void setup()
{
   ...
   add_menu_item("Malt whisky", ALCOHOL, 200, 6, 100, 100,
      "feel a gentle burning down your throat", "drinks a shot of whisky" );
   add_menu_item("Dwarven spirits", ALCOHOL, 500, 15, 200, 200,
